...
class StatuspelaksanaanTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table("statuspelaksanaan")->insert([ "id" => 3, "name" => "Pending", "description" => "Pending", "image" => null, "numsort" => 30, "status" => 1 ]);  
        DB::table("statuspelaksanaan")->insert([ "id" => 4, "name" => "Cancel", "description" => "Cancel", "image" => null, "numsort" => 40, "status" => 1 ]);  
    }
}
