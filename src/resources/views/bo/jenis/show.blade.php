...
@section('content_title', 'Mater Jenis Kegiatan')
...
<!-- button edit -->
<li class="nav-item">
    <a class="nav-link" href="{{ route('jenis.edit', ['jenis' => $viewModel->data->id]) }}">
...
<li class="nav-item">
    ...
    <form id="frmData" role="form" id="frmData" method="POST" action="{{ route('jenis.destroy', ['jenis' => $viewModel->data->id]) }}">
        @csrf
        @method('DELETE')
    </form>
</li>
